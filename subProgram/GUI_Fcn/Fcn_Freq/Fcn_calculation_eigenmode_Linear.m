...
% Linear
global CI
[R1,~]     = Fcn_boundary_condition(s_star); % B.B. 05/07/2019 - R2 output ignored
% B.B. 05/07/2019 - Rs commented out
...
for ss = 1:CI.TP.numSection-1 
    ...
    Array(:,ss+1)    = CI.TPM.Z{ss}*Array(:,ss); % B.B. 05/07/2019 - output suppressed
end
